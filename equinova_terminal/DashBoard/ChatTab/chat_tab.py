...
from equinova_terminal.utils.Logging.logger import info, error, debug, warning
...
class ChatTab(BaseTab):
    ...
    def _initialize_api_client(self):
        ...
        try:
            from equinova_terminal.utils.APIClient.api_client import create_api_client
    ...
    def create_terminal_header(self):
        ...
        try:
            with dpg.group(horizontal=True):
                self.safe_add_text("EQUINOVA", color=self.BLOOMBERG_ORANGE)
        ...
        try:
            ...
            with dpg.group(parent="messages_display_area", tag="welcome_screen"):
                ...
                with dpg.group(horizontal=True):
                    ...
                    with dpg.group():
                        self.safe_add_text("EQUINOVA AI ASSISTANT", color=self.BLOOMBERG_ORANGE)
