...
from equinova_terminal.utils.Logging.logger import info, error, warning, monitor_performance, operation
...
You can proceed with data operations."""
    ...
    def get_auth_headers(self):
        ...
        try:
            ...
            # Add user agent
            headers["User-Agent"] = "EquiNova-Terminal/1.0"

            return headers

        except Exception as e:
            error("Auth headers generation error", context={"error": str(e)}, exc_info=True)
            return {"Content-Type": "application/json", "User-Agent": "EquiNova-Terminal/1.0"}
