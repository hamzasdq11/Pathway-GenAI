...
class LiveMarketplaceInterface:
    ...
    def setup_ui(self):
        ...
        try:
            ...
            dpg.create_viewport(
                title="EquiNova Live Marketplace",
    ...
    def create_login_window(self):
        ...
        with dpg.window(label="Login to EquiNova Marketplace", tag="login_window",
                        width=400, height=300, no_resize=True, modal=True, pos=[500, 300]):
            dpg.add_text("Welcome to EquiNova Marketplace")
            dpg.add_separator()
    ...
    def create_main_interface(self):
        ...
        with dpg.window(label="EquiNova Marketplace", tag="main_window",
    ...
    def create_header(self):
        ...
        with dpg.child_window(width=-1, height=60, border=True, no_scrollbar=True):
            with dpg.group(horizontal=True):
                dpg.add_text("EQUINOVA", color=[64, 156, 255, 255])
