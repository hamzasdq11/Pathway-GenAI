...
from equinova_terminal.utils.Logging.logger import info, error, warning, debug, monitor_performance, operation
...
class DBnomicsTab(BaseTab):
    ...
    def __init__(self, main_app=None, *args, **kwargs):
        ...
        self.session.headers.update({'User-Agent': 'EquiNova-Terminal/1.0'})
