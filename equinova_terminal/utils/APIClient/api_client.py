...
def create_api_client(session_data: Dict[str, Any]) -> EquiNovaAPIClient:
    """Create API client instance from session data"""
    client = EquiNovaAPIClient(session_data)
...
def create_mock_api_client(user_type: str = "guest") -> EquiNovaAPIClient:
...
def get_api_client_info(client: EquiNovaAPIClient) -> Dict[str, Any]:
