...
class LogConfig:
    ...
    def __init__(self):
        ...
        self.debug_mode = os.getenv('EQUINOVA_DEBUG', 'false').lower() == 'true'
        self.log_level = getattr(logging, os.getenv('EQUINOVA_LOG_LEVEL', 'INFO').upper(), logging.INFO)
        self.console_enabled = os.getenv('EQUINOVA_CONSOLE_LOG', 'false').lower() == 'true'

        # File rotation settings
        self.max_file_size = int(os.getenv('EQUINOVA_MAX_LOG_SIZE', str(50 * 1024 * 1024)))  # 50MB
        self.backup_count = int(os.getenv('EQUINOVA_BACKUP_COUNT', '10'))
        self.retention_days = int(os.getenv('EQUINOVA_RETENTION_DAYS', '30'))
    ...
    def get_logs_dir(self) -> Path:
        ...
        if env_dir := os.getenv('EQUINOVA_LOGS_DIR'):
