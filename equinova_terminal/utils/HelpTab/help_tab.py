...
class HelpTab(BaseTab):
    ...
    def _create_about_tab(self):
        ...
        dpg.add_text("ABOUT EQUINOVA TERMINAL", color=self.BLOOMBERG_ORANGE)
        dpg.add_separator()

        # Company info in Bloomberg style
        with dpg.group(horizontal=True):
            with dpg.group():
                dpg.add_text("EquiNova Financial Terminal", color=self.BLOOMBERG_ORANGE)
        ...
        # Description
        about_text = (
            "EquiNova is a cutting-edge financial analysis platform designed to provide "
