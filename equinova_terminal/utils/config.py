# config.py - Centralized Configuration for EquiNova API
"""
...
class APIConfig:
    ...
    APP_NAME = "EquiNova Financial Terminal"
    APP_VERSION = "2.1.0"

    # Logging Configuration
    LOG_LEVEL = os.getenv("EQUINOVA_LOG_LEVEL", "INFO").upper()
    DEBUG_MODE = os.getenv("EQUINOVA_DEBUG", "false").lower() == "true"
