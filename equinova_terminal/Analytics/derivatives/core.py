"""
EquiNova - Derivatives Core Module
==========================================

Core classes, interfaces, and validation for derivatives analytics.
Implements CFA Level I & II foundations with industry-standard precision.
