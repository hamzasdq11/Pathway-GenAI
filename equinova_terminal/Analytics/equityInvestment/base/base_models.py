"""
Base Models for EquiNova Core Analytics Module
Provides abstract base classes and common interfaces for all analytical models
"""
...
class EquiNovaAnalyticsError(Exception):
    """Base exception for analytics module"""
    pass


class DataProviderError(EquiNovaAnalyticsError):
    """Exception for data provider issues"""
    pass


class ValidationError(EquiNovaAnalyticsError):
    """Exception for input validation failures"""
    pass


class CalculationError(EquiNovaAnalyticsError):
    """Exception for calculation failures"""
    pass


class ModelError(EquiNovaAnalyticsError):
